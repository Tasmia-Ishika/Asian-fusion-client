            ...
            <div className="border-double border-4 border-yellow-400 rounded-2xl p-10 m-10">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-control">
                        ...
                        <textarea defaultValue={recipe} {...register('recipe')} className="textarea textarea-warning w-full" placeholder="Bio"></textarea>
                    </div>
                    ...
                    <button className="btn btn-warning">Update an Item <GiForkKnifeSpoon size={20}/></button>
                </form>
            </div>
        </div>
    );
